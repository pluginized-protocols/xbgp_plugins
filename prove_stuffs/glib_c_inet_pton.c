//
// Created by thomas on 7/12/21.
//

/* code taken from glibc project (https://code.woboq.org/userspace/glibc/resolv/inet_pton.c) */
...
int
my_inet_pton_length (int af, const char *src, size_t srclen, void *dst)
{
    switch (af)
    {
        case AF_INET:
...
{
    return my_inet_pton_length (af, src, strlen (src), dst);
}
